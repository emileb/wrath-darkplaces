        ...
        case PORT_ACT_INVEN: // Open runes
            {
                ...
                int activate = SmartToggleAction( &smartToggle, state, KeyIsDown(&in_button6));
                (activate)?KeyDownPort(&in_button6):KeyUpPort(&in_button6);
                break;
            }
