...
cvar_t vid_fullscreen = {CVAR_SAVE, "vid_fullscreen", "0", "use fullscreen (1) or windowed (0)"};
cvar_t vid_width = {CVAR_SAVE, "vid_width", "1280", "resolution"};
cvar_t vid_height = {CVAR_SAVE, "vid_height", "720", "resolution"};
